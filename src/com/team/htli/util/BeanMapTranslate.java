 ...
 */
public class BeanMapTranslate {

	static Logger logger = Logger.getLogger(BeanMapTranslate.class.getName());
	...
	public static Map<String, String> transBean2MapByString(Object obj) {
		if (obj == null) {
			return null;
		}
